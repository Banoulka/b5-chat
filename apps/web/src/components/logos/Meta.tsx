...
const FacebookMetaLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
	<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 287.56 191" {...props}>
		<defs>
			<linearGradient
				id="linear-gradient"
				x1="62.34"
...
export default FacebookMetaLogo;
