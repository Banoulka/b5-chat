			...
			<SidebarContext.Provider value={contextValue}>
				<TooltipProvider delayDuration={0}>
					<div
						...
						className={cn(
							'group/sidebar-wrapper has-data-[variant=inset]:jitter-bg flex min-h-svh w-full',
							className,
						)}
						ref={ref}
						{...props}
...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
	...
	if (collapsible === 'none') {
		return (
			<div
				className={cn('jitter-bg text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col', className)}
				ref={ref}
				{...props}
			>
				{children}
		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				<SheetContent
					...
					data-mobile="true"
					className="jitter-bg text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
					style={
						{
	...
	return (
		...
		>
			...
			>
				<div
					data-sidebar="sidebar"
					className="jitter-bg group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
				>
					{children}
				</div>
			</div>
	...
	return (
		<button
			...
			className={cn(
				...
				'hover:group-data-[collapsible=offcanvas]:jitter-bg group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full',
